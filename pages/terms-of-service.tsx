    ...
    return (
        <main
            ...
            <div
                ...
                <p>
                    Welcome to PS2 Filter, accessible from ps2filter.art. Please read these Terms
                    of Service ("Terms", "Terms of Service") carefully before using the PS2 Filter web
                    application ("Service").
                </p>
                ...
                <p>
                    <ul className="list-inside list-disc">
                        ...
                        <li>
                            PS2 Filter has the right, but not the obligation, to monitor and review any
                ...
                <p>
                    All content, features, and functionality of the Service are owned by PS2 Filter, its
                ...
                <p>
                    The Service is provided on an "as is" and "as available" basis. PS2 Filter makes no
                ...
                <p>
                    In no event shall PS2 Filter, nor its directors, employees, partners, or agents, be
